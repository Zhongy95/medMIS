...
INSERT INTO `bus_doctortime` VALUES (1,11,'2020-06-11 12:00:00','2020-06-11 20:00:00',20,20),(11,8,'2020-06-13 12:00:00','2020-06-13 20:00:00',2,100),(12,12,'2020-06-13 12:00:00','2020-06-13 20:00:00',19,20),(13,13,'2020-06-13 12:00:00','2020-06-13 20:00:00',20,20),(14,14,'2020-06-13 12:00:00','2020-06-13 20:00:00',20,20),(15,17,'2020-06-13 12:00:00','2020-06-13 20:00:00',20,20),(16,18,'2020-06-13 12:00:00','2020-06-13 20:00:00',20,20),(17,19,'2020-06-13 12:00:00','2020-06-13 20:00:00',18,20);
...
CREATE TABLE `bus_examdoc` (
  `examdoc_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `bus_examqueue` (
  ...
  `examregister_id` int(11) NOT NULL,
  `available` tinyint(4) NOT NULL DEFAULT '1',
...
CREATE TABLE `bus_examregister` (
  `examregister_id` int(11) NOT NULL AUTO_INCREMENT,
  `exam_id` int(11) NOT NULL,
  `createtime` timestamp NOT NULL,
  `payment_id` int(11) NOT NULL,
  `payment_ifdone` tinyint(4) NOT NULL,
  `available` tinyint(4) NOT NULL DEFAULT '1',
  `examtime_id` int(11) NOT NULL,
  `examtodo_id` int(11) NOT NULL,
...
CREATE TABLE `bus_examtime` (
  `eaxmtime_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `bus_examtodo` (
  `examtodo_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `bus_meddoc` (
  `meddoc_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `bus_medtodo` (
  `medtodo_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `bus_payment` (
  ...
  `info` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '缴费备注',
...
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='缴费单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bus_payment` VALUES (1,1,2,NULL,'2020-06-20 00:00:00','2020-06-13 15:33:20',1,23.9,1),(46,1,2,NULL,'2020-06-14 04:13:26',NULL,1,20,0),(48,1,2,NULL,'2020-06-14 04:15:44',NULL,1,20,0),(55,1,2,'挂号医生为李时珍,挂号时间为2020-06-13 20:00:00~2020-06-14 04:00:00','2020-06-14 09:33:28','2020-06-14 09:35:33',1,20,1);
...
CREATE TABLE `bus_paymentitem` (
  ...
  `paymentitem_name` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='挂号单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bus_register` VALUES (41,2,12,'2020-06-14 04:13:26',46,0,1,12),(43,2,19,'2020-06-14 04:15:44',48,0,1,17),(50,2,19,'2020-06-14 09:33:28',55,1,1,17);
...
CREATE TABLE `bus_treatdoc` (
  `treatdoc_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `bus_treattodo` (
  `treattodo_id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2020-06-16  9:40:05
