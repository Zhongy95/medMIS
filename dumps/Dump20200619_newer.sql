...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COMMENT='检查预约单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bus_examregister` VALUES (12,1,'2020-06-19 01:33:58',86,1,1,1,2),(13,1,'2020-06-19 01:35:37',87,1,1,2,2),(14,1,'2020-06-19 01:36:44',88,1,1,2,2);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='检验工作时间';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='医生给患者开具的待检查项目单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bus_examtodo` VALUES (2,1,1,'2020-06-19 10:15:27',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=89 DEFAULT CHARSET=utf8mb4 COMMENT='缴费单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='病历记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bus_record` VALUES (1,2,8,'多喝热水多喝热水多喝热水多喝热水多喝热水多喝热水多喝热水多喝热水多喝热水多喝热水多喝热水多喝热水','2020-06-18 10:35:53',0,0,0,1,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8mb4 COMMENT='挂号单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='排队看病';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bus_registerqueue` VALUES (2,2,43,1,1),(3,3,67,1,1),(4,2,68,1,1);
...
CREATE TABLE `sys_loginfo` (
  ...
  PRIMARY KEY (`li_id`)
) ENGINE=InnoDB AUTO_INCREMENT=565 DEFAULT CHARSET=utf8 COMMENT='登录记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-06-19 17:51:20
