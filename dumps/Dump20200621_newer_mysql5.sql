...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='检查项目';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bus_exam` VALUES (1,'验血',23,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='检查预约单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bus_examregister` VALUES (15,1,'2020-06-20 05:51:41',89,1,1,2,6);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='检验工作时间';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bus_examtime` VALUES (1,1,'2020-06-19 09:23:30','2020-06-19 10:15:27',19),(2,1,'2020-06-18 09:23:30','2020-06-18 09:23:30',17);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='医生给患者开具的待检查项目单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bus_examtodo` VALUES (6,68,19,1,'2020-06-20 07:08:18',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=90 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='缴费单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='病历记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bus_record` VALUES (1,2,8,'多喝热水多喝热水多喝热水多喝热水多喝热水多喝热水多喝热水多喝热水多喝热水多喝热水多喝热水多喝热水','2020-06-18 10:35:53',0,0,0,1,0,0),(19,20,12,'ok了','2020-06-20 07:08:25',1,0,0,1,0,68);
...
INSERT INTO `bus_register` VALUES (41,2,12,'2020-06-14 04:13:26',46,0,1,12),(43,2,19,'2020-06-14 04:15:44',48,0,1,17),(50,2,19,'2020-06-14 09:33:28',55,1,1,17),(51,2,17,'2020-06-17 00:43:10',56,1,1,15),(52,2,17,'2020-06-17 00:43:14',57,1,1,15),(53,2,11,'2020-06-17 00:43:18',58,1,1,1),(54,2,18,'2020-06-17 00:43:29',59,1,1,16),(55,2,19,'2020-06-17 00:43:34',60,1,1,17),(56,2,11,'2020-06-17 00:52:26',61,1,1,1),(57,2,13,'2020-06-17 00:54:08',62,1,1,13),(58,2,11,'2020-06-17 00:54:45',63,1,1,1),(59,2,11,'2020-06-17 00:56:58',64,1,1,1),(60,2,11,'2020-06-17 00:57:16',65,1,1,1),(61,2,11,'2020-06-17 01:10:10',66,1,1,1),(62,2,8,'2020-06-17 01:10:47',67,1,1,11),(63,2,8,'2020-06-17 01:11:42',68,1,1,11),(64,2,11,'2020-06-17 01:13:33',69,1,1,1),(65,2,14,'2020-06-17 01:13:42',70,1,1,14),(66,2,11,'2020-06-17 01:14:08',71,1,1,1),(67,2,11,'2020-06-17 01:14:51',72,1,1,1),(68,20,12,'2020-06-18 17:56:59',73,1,1,12),(69,2,11,'2020-06-19 09:25:51',83,1,1,1);
...
INSERT INTO `bus_registerqueue` VALUES (2,43,1,1,'2020-06-13 14:55:38'),(3,67,1,1,'2020-06-14 14:55:45'),(4,68,1,3,'2020-06-11 14:55:51');
...
CREATE TABLE `sys_loginfo` (
  ...
  PRIMARY KEY (`li_id`)
) ENGINE=InnoDB AUTO_INCREMENT=635 DEFAULT CHARSET=utf8 COMMENT='登录记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=141 DEFAULT CHARSET=utf8 COMMENT='用户权限管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=112 DEFAULT CHARSET=utf8 COMMENT='角色-权限连接';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-06-20 22:16:41
