...
INSERT INTO `bus_registerqueue` VALUES (2,43,1,3,'2020-06-13 14:55:38'),(3,67,1,3,'2020-06-14 14:55:45'),(4,68,1,3,'2020-06-11 14:55:51'),(5,66,0,3,'2020-06-23 01:18:33'),(8,64,1,3,'2020-06-23 11:38:23'),(9,63,1,1,'2020-06-23 11:43:03'),(10,68,1,3,'2020-06-26 00:33:26');
...
CREATE TABLE `sys_loginfo` (
  ...
  PRIMARY KEY (`li_id`)
) ENGINE=InnoDB AUTO_INCREMENT=732 DEFAULT CHARSET=utf8 COMMENT='登录记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=145 DEFAULT CHARSET=utf8 COMMENT='用户权限管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=120 DEFAULT CHARSET=utf8 COMMENT='角色-权限连接';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role_permission` VALUES (97,1,3),(101,1,125),(102,1,126),(98,1,130),(99,1,131),(100,1,132),(103,1,133),(108,3,135),(109,3,138),(110,3,139),(111,3,140),(112,3,141),(113,4,4),(115,4,142),(116,4,143),(119,4,144),(69,5,2),(93,5,3),(114,5,4),(74,5,7),(75,5,8),(76,5,9),(91,5,10),(92,5,11),(117,5,12),(118,5,13),(94,5,127),(95,5,128),(96,5,129),(104,5,134),(105,5,135),(106,5,136),(107,5,137),(68,6,1),(71,6,4),(72,6,5),(73,6,6),(79,6,12),(80,6,13),(81,6,14),(82,6,15),(83,6,16),(84,6,17),(85,6,18),(90,6,19),(86,6,21),(87,6,22),(88,6,23),(89,6,122);
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='用户信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-06-26  2:08:45
