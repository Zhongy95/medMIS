...
public class ResultObj {
  ...
  public static final ResultObj UPDATE_SUCCES = new ResultObj(Constast.OK, "更新成功");
  public static final ResultObj UPDATE_ERROR = new ResultObj(Constast.ERROR, "更新失败");

  public static final ResultObj ADD_SUCCES = new ResultObj(Constast.OK, "增加成功");
  public static final ResultObj ADD_ERROR = new ResultObj(Constast.ERROR, "增加失败");

  public static final ResultObj RESET_SUCCES = new ResultObj(Constast.OK, "重置成功");
  public static final ResultObj RESET_ERROR = new ResultObj(Constast.ERROR, "重置失败");

  public static final ResultObj DISPATCH_SUCCES = new ResultObj(Constast.OK, "分配成功");
